module github.com/gerinsp/rivus
...
// Temporary fork: Iceberg Go v0.6.0 plus the positional-delete batch-index fix
// and shared-manifest deduplication during snapshot-expiration cleanup.
replace github.com/apache/iceberg-go => github.com/gerinsp/iceberg-go v0.0.0-20260909105748-65063faf4977
