...
function renderIcebergMaintenance(job) {
  ...
  if (!maintenance.enabled) {
    setInnerHTMLIfChanged(panel, `
      <div class="flex flex-col gap-3 px-5 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-6">
        <div>
          <div class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Iceberg Maintenance</div>
          <div class="mt-2 text-sm text-slate-600">Automatic maintenance monitoring is disabled for this job.</div>
        </div>
  ...
  setInnerHTMLIfChanged(panel, `
    <div class="border-b border-slate-200 px-5 py-4 sm:px-6">
      <div class="flex flex-col gap-3 lg:flex-row lg:items-start lg:justify-between">
        <div>
          <div class="text-xs font-semibold uppercase tracking-[0.18em] text-slate-500">Iceberg Maintenance</div>
          <div class="mt-2 text-sm text-slate-600">Current active file inventory and automatic-compaction progress.</div>
        </div>
        <div class="flex flex-wrap items-center gap-2">
          ...
          <a href="/ui/admin/iceberg-maintenance/runs" target="_blank" rel="noopener noreferrer" class="brand-outline-btn rounded-md px-3 py-1.5 text-xs font-semibold">View maintenance runs</a>
        </div>
      </div>
